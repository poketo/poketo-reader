      ...
      <div className="pv-4 ph-3 ph-0-m">
        <div className="Markdown">
          ...
          <p className="pa-3 bgc-extraFadedLightCoral br-4">
            ...
            Poketo is still in development. It's usable now, but there's still some rough parts.
            Watch your step!
          </p>
          ...
          <QuestionContainer id="sites" question="What sites are supported?">
            <p>
              ...
              <a href={config.githubSupportedSites} target="_blank" rel="noopener noreferrer">
          ...
          <QuestionContainer
            ...
            <p>
              Honestly, I'm not sure. I know a lot of work goes into translating series, and I don't
              want Poketo to take away from traffic, ad revenue or other ways scanlators support
              their work.
            </p>
            <p>
